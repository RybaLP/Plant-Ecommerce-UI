...
const ConiferousPage = () => {
  ...
  const {data : plantsData, isLoading} = usePlantsByCategory("CONIFEROUS" as PlantType, currentPage);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Ładowanie roślin iglastych...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Brak roślin iglastych</h2>
          <p className="text-gray-600">Aktualnie nie mamy dostępnych roślin iglastych w ofercie.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Rośliny Iglaste</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Odkryj naszą kolekcję wiecznie zielonych roślin iglastych, idealnych do każdego ogrodu
          </p>
        </div>
